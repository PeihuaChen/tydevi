...
public class Analyzer
{
	static public enum TypedDependenciesFactory
	{
		...
		public Collection<TypedDependency> make(final GrammaticalStructure thisStructure)
		{
			switch (this)
			{
			case ALL:
	 ...
	 */
	static public Collection<TypedDependency> dependencies(final Tree thisTree)
	{
		final GrammaticalStructure thisStructure = Analyzer.theGrammaticalStructureFactory.newGrammaticalStructure(thisTree);
